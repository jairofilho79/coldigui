...
Future<void> syncActivePlaylistFromCarousel(Ref ref) async {
  ...
  await ref.read(updatePlaylistProvider)(playlistId: activeId, pdfIds: pdfIds);

  final playlist = await ref.read(playlistRepositoryProvider).getById(activeId);
  if (playlist != null && playlist.salva) {
